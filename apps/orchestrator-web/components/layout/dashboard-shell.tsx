...
export function DashboardShell({ children }: DashboardShellProps) {
  return (
    <div className="relative flex h-screen overflow-hidden bg-[color:var(--background)] text-[color:var(--foreground)]">
      ...
      <div className="relative m-3 flex h-[calc(100vh-1.5rem)] w-full overflow-hidden rounded-[8px] border border-[color:var(--line-strong)] bg-[color:color-mix(in_oklch,var(--surface)_90%,black_10%)] shadow-[0_18px_46px_rgba(0,0,0,0.28)]">
        <Sidebar />
