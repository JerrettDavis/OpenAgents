  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto flex w-full max-w-[1480px] flex-col gap-4">
        <section className="console-surface-strong console-hairline overflow-hidden rounded-[3px] p-5 lg:p-6">
          <div className="grid gap-6 lg:grid-cols-[minmax(0,1.25fr)_minmax(320px,0.8fr)]">
            <div className="space-y-5">
              <div className="flex items-center gap-3">
                <div className="flex h-11 w-11 items-center justify-center rounded-[2px] border border-[color:color-mix(in_oklch,var(--line-strong)_44%,transparent)] bg-[color:color-mix(in_oklch,var(--surface-strong)_92%,transparent)] text-xs font-black tracking-[0.14em] text-[color:var(--accent)]">
                  OA
                </div>
                <div>
              ...
              <div className="flex flex-wrap gap-3">
                <a
                  href="/jobs"
                  className="rounded-[2px] border border-[color:color-mix(in_oklch,var(--accent)_38%,var(--line-strong))] bg-[color:color-mix(in_oklch,var(--accent)_18%,transparent)] px-5 py-3 text-sm font-semibold text-[color:var(--foreground)] transition hover:bg-[color:color-mix(in_oklch,var(--accent)_24%,transparent)]"
                >
                  Open dashboard
                </a>
                <a
                  href="/workflows"
                  className="rounded-[2px] border border-[color:var(--line)] px-5 py-3 text-sm font-semibold text-[color:var(--foreground-soft)] transition hover:border-[color:var(--line-strong)] hover:text-[color:var(--foreground)]"
                >
                  Inspect workflows
                </a>
                <a
              ...
              <div className="flex flex-wrap gap-2">
                {providers.map((provider) => (
                  <span
                    key={provider}
                    className="rounded-[2px] border border-[color:var(--line)] bg-black/10 px-2.5 py-1.5 text-[11px] font-semibold uppercase tracking-[0.08em] text-[color:var(--foreground-soft)]"
                  >
                    {provider}
                  </span>
                ))}
            ...
            <div className="space-y-4">
              <div className="console-surface rounded-[3px] p-4">
                <div className="flex items-center justify-between gap-3">
                  ...
                  <div className="rounded-[2px] border border-emerald-800/80 bg-emerald-950/60 px-3 py-1 text-[0.68rem] font-semibold uppercase tracking-[0.08em] text-emerald-200">
                    Stable
                  </div>
                </div>
              ...
              <div className="console-surface rounded-[3px] p-4">
                ...
                <div className="mt-4 space-y-2.5">
                  {[
                    ...
                    <div
                      key={item}
                      className="flex items-start gap-3 rounded-[2px] border border-[color:var(--line)] bg-black/10 px-3.5 py-3"
                    >
                      <span className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-[2px] border border-[color:color-mix(in_oklch,var(--line-strong)_42%,transparent)] text-[0.72rem] font-semibold text-[color:var(--accent)]">
                        0{index + 1}
                      </span>
...
function MetricTile({ label, value, note }: { label: string; value: string; note: string }) {
  return (
    <div className="rounded-[2px] border border-[color:var(--line)] bg-black/10 px-3.5 py-3">
